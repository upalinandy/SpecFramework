...
namespace SpecFramework.SL.TestProject.Tests.Suite.FeatureFiles
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("GoogleApi", Description="\tTo test the latitude and longgitude for location", SourceFile="Tests\\Suite\\FeatureFiles\\GoogleApi.feature", SourceLine=0)]
    public partial class GoogleApiFeature
    {
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Verify Latitude and Longitude, 1600+Amphitheatre+Parkway,+Mountain+View,+CA", new string[] {
                "api",
                "source:..\\..\\..\\Resources\\TestData\\APIData.xlsx"}, SourceLine=0)]
        public virtual void VerifyLatitudeAndLongitude_1600AmphitheatreParkwayMountainViewCA()
        {
            this.VerifyLatitudeAndLongitude("1600+Amphitheatre+Parkway,+Mountain+View,+CA", "37.422408", "-122.0856086", new string[] {
